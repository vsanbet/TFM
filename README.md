...
![Imagen de la primera parte de la pipeline](pipeline_images/pipeline_esquema_1.svg)
...
![Imagen de la segunda parte de la pipeline](pipeline_images/pipeline_esquema_2.svg)

### Population structure
Scripts para el estudio de la estructura poblacional de las muestras
- **Plink PCA**
- **Admixture** K=1-10, 10 runs/K
- **CLUMPAK** K=5
- Visualización con **R** (ggtree, custom scripts)

![Imagen de la tercera parte de la pipeline](pipeline_images/pipeline_esquema_3.svg)
